...
cleaned_biased_word <- biased_word %>%
  select(-c(block1_mean.1, block2_mean.1, block3_mean.1, block4_mean.1, 
            block1_bias.1, block2_bias.1, block3_bias.1, block4_bias.1, Subject.1))
...
# Now you can proceed with adding error bars or plotting
...
```{r}
demographics_data <-read.csv("~/Library/CloudStorage/OneDrive-UW/CCDL/MGH Research Project/Copy of CardSortingTask_Analysis_09.28.2023.csv")
...
```
```{r demographics}
parc_cardsort <- read.csv("~/Library/CloudStorage/OneDrive-UW/CCDL/MGH Research Project/CardSort_Summary(in).csv")
parc_demographics <- read.csv("~/Library/CloudStorage/OneDrive-UW/CCDL/MGH Research Project/Demographics_Summary(in).csv")

parc_merged <- merge(parc_demographics, parc_cardsort, by = "Subject")
maia_data <- read.csv("CardSort Data.csv")
lang_data <- read.csv("~/Library/CloudStorage/OneDrive-UW/CCDL/MGH Research Project/CardSortLanguage.csv")
